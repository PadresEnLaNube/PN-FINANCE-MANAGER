...
class PN_PERSONAL_FINANCE_MANAGER_Common {
	...
	public function pn_personal_finance_manager_enqueue_styles() {
		...
		if (!wp_style_is($this->plugin_name . '-popups', 'enqueued')) {
				wp_enqueue_style($this->plugin_name . '-popups', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/pn-personal-finance-manager-popups.css', [], $this->version, 'all');
		}
		...
		if (!wp_style_is($this->plugin_name . '-stocks', 'enqueued')) {
				wp_enqueue_style($this->plugin_name . '-stocks', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/pn-personal-finance-manager-stocks.css', [], $this->version, 'all');
		}

		if (!wp_style_is($this->plugin_name . '-statistics', 'enqueued')) {
				wp_enqueue_style($this->plugin_name . '-statistics', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/pn-personal-finance-manager-statistics.css', [], $this->version, 'all');
		}

		if (!wp_style_is($this->plugin_name . '-watchlist', 'enqueued')) {
				wp_enqueue_style($this->plugin_name . '-watchlist', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/pn-personal-finance-manager-watchlist.css', [], $this->version, 'all');
		}

		if (!wp_style_is($this->plugin_name . '-nav', 'enqueued')) {
				wp_enqueue_style($this->plugin_name . '-nav', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/pn-personal-finance-manager-nav.css', [], $this->version, 'all');
		}

		if (!wp_style_is($this->plugin_name . '-amortization', 'enqueued')) {
				wp_enqueue_style($this->plugin_name . '-amortization', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/pn-personal-finance-manager-amortization.css', [], $this->version, 'all');
		}

		wp_enqueue_style($this->plugin_name, PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/pn-personal-finance-manager.css', [], $this->version, 'all');

		$primary_color = get_option('pn_personal_finance_manager_color_primary', '#008080');
    ...
    if(!wp_script_is($this->plugin_name . '-popups', 'enqueued')) {
      wp_enqueue_script($this->plugin_name . '-popups', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/js/pn-personal-finance-manager-popups.js', ['jquery'], $this->version, false, ['in_footer' => true, 'strategy' => 'defer']);
    }

    if(!wp_script_is($this->plugin_name . '-selector', 'enqueued')) {
      wp_enqueue_script($this->plugin_name . '-selector', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/js/pn-personal-finance-manager-selector.js', ['jquery'], $this->version, false, ['in_footer' => true, 'strategy' => 'defer']);
    }

    if(!wp_script_is('pn-personal-finance-manager-tooltips', 'enqueued')) {
		...
		wp_enqueue_script($this->plugin_name . '-statistics', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/js/pn-personal-finance-manager-statistics.js', ['jquery', 'pn-personal-finance-manager-chartjs'], $this->version, false, ['in_footer' => true, 'strategy' => 'defer']);

		wp_enqueue_script($this->plugin_name . '-watchlist', PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/js/pn-personal-finance-manager-watchlist.js', ['jquery'], $this->version, false, ['in_footer' => true, 'strategy' => 'defer']);
		...
		wp_localize_script($this->plugin_name . '-stocks', 'pn_personal_finance_manager_i18n', [
			...
			'search_new_symbol' => esc_html(__('Search new symbol', 'pn-personal-finance-manager')),
			'search' => esc_html(__('Search', 'pn-personal-finance-manager')),
			'searching_symbol' => esc_html(__('Searching...', 'pn-personal-finance-manager')),
			'symbol_found' => esc_html(__('Symbol found and added!', 'pn-personal-finance-manager')),
			'symbol_not_found' => esc_html(__('Symbol not found. Check the ticker and try again.', 'pn-personal-finance-manager')),
			'enter_symbol' => esc_html(__('Enter a stock symbol (e.g. AAPL)', 'pn-personal-finance-manager')),
			'select_correct_match' => esc_html(__('Multiple matches found. Select the correct one:', 'pn-personal-finance-manager')),
			'add_symbol' => esc_html(__('Add', 'pn-personal-finance-manager')),
			...
			'liabilities' => esc_html(__('Liabilities', 'pn-personal-finance-manager')),
			'net_worth' => esc_html(__('Net Worth', 'pn-personal-finance-manager')),
			'total_assets' => esc_html(__('Total Assets', 'pn-personal-finance-manager')),
			'total_liabilities' => esc_html(__('Total Liabilities', 'pn-personal-finance-manager')),
			'no_liabilities_found' => esc_html(__('No liabilities found.', 'pn-personal-finance-manager')),
			'financial_overview' => esc_html(__('Financial Overview', 'pn-personal-finance-manager')),
			...
			'export_portfolio' => esc_html(__('Export Portfolio', 'pn-personal-finance-manager')),
			'import_portfolio' => esc_html(__('Import Portfolio', 'pn-personal-finance-manager')),
			'exporting' => esc_html(__('Exporting...', 'pn-personal-finance-manager')),
			'importing' => esc_html(__('Importing...', 'pn-personal-finance-manager')),
			'export_success' => esc_html(__('Portfolio exported successfully!', 'pn-personal-finance-manager')),
			'import_success' => esc_html(__('Portfolio imported successfully!', 'pn-personal-finance-manager')),
			'import_error' => esc_html(__('Error importing portfolio.', 'pn-personal-finance-manager')),
			'no_file_selected' => esc_html(__('No file selected', 'pn-personal-finance-manager')),
			'select_file_first' => esc_html(__('Please select a file first.', 'pn-personal-finance-manager')),
			'invalid_file_format' => esc_html(__('Invalid file format.', 'pn-personal-finance-manager')),
			'assets_imported' => esc_html(__('assets imported', 'pn-personal-finance-manager')),
			'liabilities_imported' => esc_html(__('liabilities imported', 'pn-personal-finance-manager')),
			'watchlist_items_imported' => esc_html(__('watchlist items imported', 'pn-personal-finance-manager')),
			'confirm_import' => esc_html(__('This will add new entries to your portfolio. Existing data will not be overwritten. Continue?', 'pn-personal-finance-manager')),

			// Currency preference translations
			'display_currency' => esc_html(__('Display Currency', 'pn-personal-finance-manager')),
			'display_currency_desc' => esc_html(__('Choose the currency used to display your investments and portfolio values.', 'pn-personal-finance-manager')),

			// Number format translations
			'number_format' => esc_html(__('Number Format', 'pn-personal-finance-manager')),
			'number_format_desc' => esc_html(__('Choose how numbers are displayed (decimal and thousands separators).', 'pn-personal-finance-manager')),

			// Portfolio performance translations
			'stock_portfolio_performance' => esc_html(__('Stock Portfolio Performance', 'pn-personal-finance-manager')),
			'crypto_portfolio_performance' => esc_html(__('Crypto Portfolio Performance', 'pn-personal-finance-manager')),
			'stock_portfolio_value' => esc_html(__('Stock Portfolio Value', 'pn-personal-finance-manager')),
			'crypto_portfolio_value' => esc_html(__('Crypto Portfolio Value', 'pn-personal-finance-manager')),
			'invested' => esc_html(__('Invested', 'pn-personal-finance-manager')),
			'current' => esc_html(__('Current', 'pn-personal-finance-manager')),

			// Comparison period translations
			'comparison_period' => esc_html(__('Comparison Period', 'pn-personal-finance-manager')),
			'comparison_period_desc' => esc_html(__('Choose the time period for price comparison displayed on your investment cards.', 'pn-personal-finance-manager')),
			'period_daily' => esc_html(__('Daily', 'pn-personal-finance-manager')),
			'period_weekly' => esc_html(__('Weekly (7d)', 'pn-personal-finance-manager')),
			'period_monthly' => esc_html(__('Monthly (30d)', 'pn-personal-finance-manager')),
			'period_yearly' => esc_html(__('Yearly (365d)', 'pn-personal-finance-manager')),
			'period_since_purchase' => esc_html(__('Since purchase', 'pn-personal-finance-manager')),

			// Amortization translations
			'amortization_schedule' => esc_html(__('Amortization Schedule', 'pn-personal-finance-manager')),

			// Alert Preferences translations
			'alert_preferences' => esc_html(__('Alert Preferences', 'pn-personal-finance-manager')),
			'alert_preferences_desc' => esc_html(__('Configure email alert preferences for price changes on your assets and watchlist items.', 'pn-personal-finance-manager')),
			'default_threshold' => esc_html(__('Default alert threshold', 'pn-personal-finance-manager')),
			'alerts_on_assets' => esc_html(__('Enable alerts on my assets', 'pn-personal-finance-manager')),
			'alerts_on_watchlist' => esc_html(__('Enable alerts on watchlist items', 'pn-personal-finance-manager')),
			'save_preferences' => esc_html(__('Save Preferences', 'pn-personal-finance-manager')),
			'preferences_saved' => esc_html(__('Preferences saved successfully!', 'pn-personal-finance-manager')),
			'saving' => esc_html(__('Saving...', 'pn-personal-finance-manager')),
			'primary_color' => sanitize_hex_color(get_option('pn_personal_finance_manager_color_primary', '#008080')),

			// Sold asset translations
			'sold' => esc_html(__('Sold', 'pn-personal-finance-manager')),
			'sale_date' => esc_html(__('Sale Date', 'pn-personal-finance-manager')),
			'sale_price' => esc_html(__('Sale Price', 'pn-personal-finance-manager')),

			// Sort translations
			'sort_ascending' => esc_html(__('Sort ascending', 'pn-personal-finance-manager')),
			'sort_descending' => esc_html(__('Sort descending', 'pn-personal-finance-manager')),
		]);

		// Keep the original localizations for backward compatibility
		wp_localize_script($this->plugin_name . '-ajax', 'pn_personal_finance_manager_ajax', [
			'ajax_url' => admin_url('admin-ajax.php'),
			'pn_personal_finance_manager_ajax_nonce' => wp_create_nonce('pn-personal-finance-manager-nonce'),
		]);

		// Add CPTs data to JavaScript
		wp_localize_script($this->plugin_name . '-ajax', 'pn_personal_finance_manager_cpts', PN_PERSONAL_FINANCE_MANAGER_CPTS);

		// Verify nonce for GET parameters
		$nonce_verified = false;
		if (!empty($_GET['pn_personal_finance_manager_nonce'])) {
			$nonce_verified = wp_verify_nonce(sanitize_text_field(wp_unslash($_GET['pn_personal_finance_manager_nonce'])), 'pn-personal-finance-manager-get-nonce');
		}

		// Only process GET parameters if nonce is verified
		$pn_personal_finance_manager_action = '';
		$pn_personal_finance_manager_btn_id = '';
		$pn_personal_finance_manager_popup = '';
		...
		wp_localize_script($this->plugin_name, 'pn_personal_finance_manager_path', [
			'main' => PN_PERSONAL_FINANCE_MANAGER_URL,
			'assets' => PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/',
			'css' => PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/css/',
			'js' => PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/js/',
			'media' => PN_PERSONAL_FINANCE_MANAGER_URL . 'assets/media/',
		]);
		
		wp_localize_script($this->plugin_name, 'pn_personal_finance_manager_action', [
			'action' => $pn_personal_finance_manager_action,
			'btn_id' => $pn_personal_finance_manager_btn_id,
			'popup' => $pn_personal_finance_manager_popup,
			'tab' => $pn_personal_finance_manager_tab,
			'nonce' => wp_create_nonce('pn-personal-finance-manager-get-nonce'),
		]);

		// Initialize popups
		PN_PERSONAL_FINANCE_MANAGER_Popups::instance();

		// Initialize selectors
		PN_PERSONAL_FINANCE_MANAGER_Selector::instance();
	}

  public function pn_personal_finance_manager_body_classes($classes) {
	  $classes[] = 'pn-personal-finance-manager-body';

	  if (!is_user_logged_in()) {
      $classes[] = 'pn-personal-finance-manager-body-unlogged';
    } else {
      $classes[] = 'pn-personal-finance-manager-body-logged-in';

      $user = new WP_User(get_current_user_id());
      foreach ($user->roles as $role) {
        $classes[] = 'pn-personal-finance-manager-body-' . $role;
      }
    }
   ...
   *
   * @since  1.3.0
   * @param  string $active  One of: portfolio, watchlist, assets, liabilities.
   * @return string          HTML of the nav bar.
   */
  public static function pn_personal_finance_manager_page_nav($active = '') {
    $pages = [
      'portfolio'   => [
        'option' => 'pn_personal_finance_manager_page_portfolio',
        'icon'   => 'account_balance_wallet',
        'label'  => __('Portfolio', 'pn-personal-finance-manager'),
      ],
      'watchlist'   => [
        'option' => 'pn_personal_finance_manager_page_watchlist',
        'icon'   => 'visibility',
        'label'  => __('Watchlist', 'pn-personal-finance-manager'),
      ],
      'assets'      => [
        'option' => 'pn_personal_finance_manager_page_assets',
        'icon'   => 'trending_up',
        'label'  => __('Assets', 'pn-personal-finance-manager'),
      ],
      'liabilities' => [
        'option' => 'pn_personal_finance_manager_page_liabilities',
        'icon'   => 'credit_card',
        'label'  => __('Liabilities', 'pn-personal-finance-manager'),
      ],
    ];

    $html = '<nav class="pn-personal-finance-manager-page-nav">';
    ...
    foreach ($pages as $key => $page) {
      ...
      $html .= '<a href="' . esc_url($url) . '" class="pn-personal-finance-manager-page-nav-link' . $is_active . '" data-hostpn-tooltip="' . esc_attr($page['label']) . '">';
      $html .= '<i class="material-icons-outlined">' . esc_html($page['icon']) . '</i>';
      $html .= '</a>';
    }
