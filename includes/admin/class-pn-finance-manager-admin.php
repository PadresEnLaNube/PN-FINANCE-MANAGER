 ...
 * @subpackage PN_FINANCE_MANAGER/admin
 * @author     Padres en la Nube
 */

if ( ! defined( 'ABSPATH' ) ) exit;

class PN_FINANCE_MANAGER_Admin {
	...
	public function pn_finance_manager_enqueue_styles() {
		wp_enqueue_style($this->plugin_name . '-admin', PN_FINANCE_MANAGER_URL . 'assets/css/admin/pn-finance-manager-admin.css', [], $this->version, 'all');
	}
	...
	public function pn_finance_manager_enqueue_scripts() {
		error_log('PnFinanceManager Debug: Admin enqueue_scripts called');
		
		wp_enqueue_media();
		wp_enqueue_script($this->plugin_name . '-admin', PN_FINANCE_MANAGER_URL . 'assets/js/admin/pn-finance-manager-admin.js', ['jquery'], $this->version, false);
		
		// Load stocks script for admin area
		error_log('PnFinanceManager Debug: Loading stocks script: ' . PN_FINANCE_MANAGER_URL . 'assets/js/pn-finance-manager-stocks.js');
		...
		error_log('PnFinanceManager Debug: Localizing scripts');
		...
		error_log('PnFinanceManager Debug: Admin scripts enqueued successfully');
	}
}
