...
class PN_PERSONAL_FINANCE_MANAGER_Functions_Post {
	/**
	 ...
	 * @since    1.0.0
	 */
	public function pn_personal_finance_manager_insert_post($title, $content, $excerpt, $name, $type, $status, $author = 1, $parent = 0, $cats = [], $tags = [], $postmeta = [], $overwrite_id = true) {
    $post_values = [
   ...
   */
  public function pn_personal_finance_manager_duplicate_post($post_id, $post_status = 'draft', $suffix = ' (copy)') {
    ...
    do_action('pn_personal_finance_manager_after_post_duplication', $new_post_id, $post_id);
